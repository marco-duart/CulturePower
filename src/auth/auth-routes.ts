...
authRoutes.post("/admin/me", adminLoginController.getUserInfo.bind(adminLoginController))

authRoutes.post("/user/login", authValidateMiddleware, userLoginController.login.bind(userLoginController))
authRoutes.post("/user/me", userLoginController.getUserInfo.bind(userLoginController))
