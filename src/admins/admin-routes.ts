...
adminRoutes.patch("/admin/:id", logMiddleware, authorizeAdminMiddleware, controller.update.bind(controller));
adminRoutes.delete("/admin/:id", logMiddleware, authorizeAdminMiddleware, controller.delete.bind(controller));
adminRoutes.patch("/admin/:userId/update-jewels", authorizeAdminMiddleware, logMiddleware, controller.updateUserJewels.bind(controller));
